...
// Sidebar reducida a la fase web (solo Inicio), con la identidad visual del
// escritorio (ferre-pos/src/layout/components/Sidebar.tsx): colapso 260↔72px,
// item activo con barra lateral primario, logo animado.
...
export function Sidebar({ isOpen, onNavigate }: { isOpen: boolean; onNavigate?: () => void }) {
  ...
  const isActive = pathname === inicioItem.to;
      ...
      >
        ...
        >
          <ListItem disablePadding>
            ...
            >
              <ListItemIcon>{inicioItem.icon}</ListItemIcon>
              <ListItemText
                primary={<Typography variant="body2" sx={{ fontWeight: 600 }}>{inicioItem.label}</Typography>}
              />
            </ListItemButton>
          </ListItem>
        </List>
